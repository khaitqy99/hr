...
const LoginScreen = ({ onLogin }: { onLogin: (user: User) => void }) => {
  ...
  return (
    <div
      className="app-min-viewport app-safe-x flex items-center justify-center bg-gradient-to-b from-blue-900 via-blue-800 to-sky-900 relative overflow-hidden"
      style={{
