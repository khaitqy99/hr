...
const AdminPanel: React.FC<AdminPanelProps> = ({ user, setView, setSelectedEmployeeId, onLogout, initialTab, onTabChange }) => {
  ...
  const tabs: Array<{ id: Tab; label: string; icon: React.ReactNode; category: 'main' | 'config' }> = [
    ...
    { id: 'HOLIDAYS', label: 'Ngày lễ', icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={iconClass}><path strokeLinecap="round" strokeLinejoin="round" d="M21 11.25v-1.5a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 9.75v1.5m18 0A2.25 2.25 0 0121 12m-18 0a2.25 2.25 0 012.25 2.25m18 0v-3a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 15v3m18 0a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 18v-3" /></svg>, category: 'config' },
    ...
    { id: 'SETTINGS', label: 'Hệ thống', icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={iconClass}><path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.227-.276.318-.468.318-.66a.75.75 0 00-.318-.66l-2.496-3.03M9 15a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" /></svg>, category: 'config' },
  ];
    ...
    <div className="flex h-screen bg-slate-50">
      ...
      <div className="w-64 bg-white border-r border-slate-200 flex flex-col">
        <div className="px-6 h-[73px] border-b border-slate-200 flex items-center gap-3">
          <img src="/logo.png" alt="Y99 HR Logo" className="h-8 w-auto max-w-8 object-contain flex-shrink-0" />
